    ...
    resources : {
        "en" : {
            translation : {
                ...
                "youAreVerified": "You are now verified in AutoScheduler!",
                "verifiedExplanaition": "We have completed the verification process for your account, which means {{universityName}} is now publicly available for students to link their account to. This will allow them to get schedules based on your published data.",
        ...
        "es" : {
            translation: {
                ...
                "youAreVerified": "¡Ha sido verificado en AutoScheduler!",
                "verifiedExplanaition": "Hemos finalizado el proceso de verificación para su cuenta, lo que signiica que {{universityName}} ya está públicamente disponible para que esudiantes asocien su cuenta con la universidad. Esto les permitirá recibir cronogramas en base a la información que usted publicó.",
