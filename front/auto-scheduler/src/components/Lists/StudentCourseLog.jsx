...
class StudentCourseLog extends Component {
    ...
    addCourse() {
        if (!this.state.courseToAdd || this.state.courseToAdd === '') return;
                    ...
                    ? [
                          <div key="div-prog">
                              ...
                              <Modal
                                  ...
                                  onHide={() => this.switchAddModal()}
                                  className="color-warning text-black"
                              >
                                  <Modal.Header closeButton>
                                      <Modal.Title>
                                          <Translation>{(t) => t('modal.addCourse')}</Translation>
                                      </Modal.Title>
                                  </Modal.Header>
                                  <Modal.Body>
                                      <Form.Select
                                      ...
                                      {this.state.courses && this.state.courses.length > 0
                                          ? [
                                                <Form.Select
                                                    ...
                                                    onChange={this.onChangeCourseToAdd.bind(this)}
                                                    className="m-2"
                                                >
                                          ...
                                          : [
                                                <div className="text-center" key="no-courses-message">
                                                    <Translation>{(t) => t('modal.noRemainingCourses')}</Translation>
                                                </div>,
                                            ]}
                                  </Modal.Body>
                                  <Modal.Footer>
                                      ...
                                      {this.state.courseToAdd && this.state.courseToAdd !== ''
                                          ? [
                                                <Button
                                                    ...
                                                    variant="secondary"
                                                    onClick={() => {
                                                        this.addCourse(this.state.courseToAdd);
                                                    }}
                                                >
