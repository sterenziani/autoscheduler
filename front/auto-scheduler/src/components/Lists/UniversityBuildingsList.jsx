...
class UniversityBuildingsList extends Component {
    ...
    loadBuildings() {
        ApiService.getBuildings(this.state.user.id).then((data) => {
            ...
            else this.setState({ buildings: data, loading: false });
        });
    }
            ...
            <React.Fragment>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>
                            <Translation>{(t) => t('modal.deleteBuilding')}</Translation>
                        </Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Translation>
                            {(t) =>
                                t('modal.areYouSureBuilding', {
                                    code: this.state.buildingToDelete.internalId,
                                    name: this.state.buildingToDelete.name,
                                })
                            }
                        </Translation>
                    </Modal.Body>
                    <Modal.Footer>
                        ...
                        <Button
                            variant="danger"
                            onClick={() => {
                                this.deleteBuilding(this.state.buildingToDelete);
                            }}
                        >
