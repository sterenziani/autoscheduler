                    ...
                    <Form.Group controlId="program" className="row mx-auto form-row">
                        <div className="col-4 text-end my-auto text-break">
                            <Form.Label className="my-0">
                                <h5 className="my-0">
                                    <strong>
                                        <Translation>{(t) => t('search.program')}</Translation>
                                    </strong>
                                </h5>
                            </Form.Label>
                        </div>
                    ...
                    <Form.Group controlId="term" className="row mx-auto form-row">
                        <div className="col-4 text-end my-auto text-break">
                            <Form.Label className="my-0">
                                <h5 className="my-0">
                                    <strong>
                                        <Translation>{(t) => t('search.term')}</Translation>
                                    </strong>
                                </h5>
                            </Form.Label>
                        </div>
                    ...
                    <Form.Group controlId="hours" className="row mx-auto form-row">
                        <div className="col-4 text-end my-auto text-break">
                            <Form.Label className="col text-end my-auto">
                                <h5 className="my-0">
                                    <strong>
                                        <Translation>{(t) => t('search.hoursPerWeek')}</Translation>
                                    </strong>
                                </h5>
                            </Form.Label>
                        </div>
                    ...
                    <Form.Group controlId="prioritize" className="row mx-auto form-row">
                        <div className="col-4 text-end my-auto text-break">
                            <Form.Label className="my-0">
                                <h5 className="my-0">
                                    <strong>
                                        <Translation>{(t) => t('search.prioritizeUnlocks')}</Translation>
                                    </strong>
                                </h5>
                            </Form.Label>
                        </div>
                        <div className="col-8 d-flex align-items-start align-items-center">
                            <Form.Check
                                checked={this.state.params.prioritizeUnlocks}
                                className="color-secondary m-0"
                                onChange={this.onChangePrioritize.bind(this)}
                            />
                        </div>
                    </Form.Group>
                    ...
                    <Form.Group controlId="reduceDays" className="row mx-auto form-row">
                        <div className="col-4 text-end my-auto text-break">
                            <Form.Label className="my-0">
                                <h5 className="my-0">
                                    <strong>
                                        <Translation>{(t) => t('search.reduceDays')}</Translation>
                                    </strong>
                                </h5>
                            </Form.Label>
                        </div>
                        <div className="col-8 d-flex align-items-start align-items-center">
                            <Form.Check
                                checked={this.state.params.reduceDays}
                                className="m-0"
                                onChange={this.onChangeReduceDays.bind(this)}
                            />
                        </div>
                    </Form.Group>
                    ...
                    <Form.Group controlId="unavailableSlots" className="row mx-auto form-row">
                        <div className="col-4 text-end my-3 text-break">
                            <Form.Label className="my-0">
                                <h5 className="my-0">
                                    <strong>
                                        <Translation>{(t) => t('search.unavailableSlots')}</Translation>
                                    </strong>
                                </h5>
                            </Form.Label>
                        </div>
                        <div className="col-8 align-items-start align-items-center">
                            {this.state.params.unavailableTimeSlots.map((entry, index) => (
                                ...
                                >
                                    <Form.Select
                                        ...
                                        value={this.state.params.unavailableTimeSlots[index].day}
                                        onChange={this.onChangeDay.bind(this)}
                                    >
                                        {DAYS.map((p) => (
                                            <option key={p} value={p}>
                                                {<Translation>{(t) => t('days.' + p)}</Translation>}
                                            </option>
                                        ))}
                                    </Form.Select>
                                    <input
                                        ...
                                        value={this.state.params.unavailableTimeSlots[index].startTime}
                            ...
                            <div className="mx-auto align-items-center plus-button-container clickable">
                                <i
                                    ...
                                    onClick={this.onClickPlusSign.bind(this)}
                                ></i>
                            </div>
                        </div>
                    </Form.Group>
