    ...
    render() {
        return (
            <React.Fragment>
                <HelmetProvider>
                    <Helmet>
                        <title>Register - AutoScheduler</title>
                    </Helmet>
                </HelmetProvider>
                <div className="container my-5">
                    <Tabs
                        className="borderless-tabs"
                        defaultActiveKey={this.props.login ? 'log_in' : 'i_am_student'}
                        fill
                    >
                        <Tab
                            className="text-center"
                            eventKey="i_am_student"
                            title={<Translation>{(t) => t('tabs.iAmStudent')}</Translation>}
                        >
                        ...
                        <Tab
                            className="text-center"
                            eventKey="log_in"
                            title={<Translation>{(t) => t('tabs.login')}</Translation>}
                        >
                            <div className="bg-primary rounded-bottom">
                                <SignInForm />
                            </div>
                        ...
                        <Tab
                            ...
                            title={<Translation>{(t) => t('tabs.iAmUniversty')}</Translation>}
                        >
                            <div className="bg-primary rounded-bottom">
                                <SignUpUniversityForm />
                            </div>
                        </Tab>
                    </Tabs>
                </div>
